...
- **`com.dextor.base`**: Reusable components and base classes for all features
...
- **`com.dextor.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.dextor` (e.g., `com.dextor.myfeature`)
